...
Reducer = {
  ...
  extend: function extend(protoProps) {
    var child = _.extend({}, _.cloneDeep(this));
  ...
  create: function create(actionName, schema, handler) {
    ...
    var fn = _.extend(Reducer.prototype, {
    ...
    fn.requestData = function (url, settings) {
      ...
      var success = function success() {
        ...
        if (!!_this.queueSuccess.length || !!this.onSuccess) {
          ...
          try {
            for (var _iterator = _this.queueSuccess[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var fail = function fail() {
        ...
        if (!!_this.queueFail.length || !!this.onFail) {
          ...
          try {
            for (var _iterator2 = _this.queueFail[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
