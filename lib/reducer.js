...
Reducer = {
  create: function create(actionName, schema, handler) {
    ...
    fn.requestData = function (url, settings) {
      ...
      var success = this.onSuccess || this.success;
      var fail = this.onFail || this.fail;

      return $[method](settings).done(success.bind(this)).fail(fail.bind(this));
    };
