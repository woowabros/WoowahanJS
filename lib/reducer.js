...
Reducer = {
  ...
  create: function create(actionName, schema, handler, successHandlers, failHandlers) {
    var _this2 = this;
    ...
    fn.requestData = function (url, settings) {
      ...
      var success = function success() {
        var queueSuccess = _.concat(_this.queueSuccess, this.queueSuccess);
      ...
      var fail = function fail() {
        var queueFail = _.concat(_this.queueFail, this.queueFail);
