...
const Reducer = {
  create(actionName, schema, handler) {
    ...
    fn.addAction = (id) => app.getApp().addAction(id);
    fn.addError = (err) => app.getApp().addError(err);
    fn.removeAction = (id) => app.getApp().removeAction(id);
    fn.getStates = () => app.getApp().getStates();
