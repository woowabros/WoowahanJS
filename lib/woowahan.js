...
Woowahan.View           = require('./view')(globalOptions);
Woowahan.Reducer        = require('./reducer')(globalOptions);
...
/** components */
Woowahan.CollectionView = require('./collection-view')(globalOptions);
Woowahan.ItemView       = require('./item-view')(globalOptions);